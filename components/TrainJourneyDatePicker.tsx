...
interface TrainJourneyDatePickerProps {
  value: string;
...
/* =========================================================
   TRAIN JOURNEY DATE PICKER
   ========================================================= */

export default function TrainJourneyDatePicker({
  value,
  onChange,
  minDate = new Date(),
}: TrainJourneyDatePickerProps) {
  const { t } = useLanguage();
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            {selectedDate ? (
              ...
              <p className="text-sm font-medium text-slate-500">dd-mm-yyyy</p>
            )}
          </div>
          ...
          <ChevronRight
            ...
            className={`
              ...
              duration-300
              ${open ? "rotate-90 text-cyan-300" : "group-hover:text-slate-400"}
            `}
          />
        </button>
      </div>
